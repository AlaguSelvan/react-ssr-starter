...
const desktopFirst = LoadableHOC({
  loader: () => import('../pages/Desktop/First'),
...
const desktopThird = LoadableHOC({
  loader: () => import('../pages/Desktop/Third'),
...
const desktopSecond = LoadableHOC({
  loader: () => import('../pages/Desktop/Second'),
...
const MobileHome = LoadableHOC({
  loader: () => import('../pages/Mobile/Home'),
...
const MobileFirst = LoadableHOC({
  loader: () => import('../pages/Mobile/About'),
